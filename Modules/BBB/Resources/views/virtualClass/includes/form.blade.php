@if (in_array(852, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 || Auth::user()->role_id == 4)
    <div class="col-lg-3">

        @if (isset($editdata))
            <form class="form-horizontal" action="{{ route('bbb.virtual-class.update', $editdata->id) }}" method="POST"
                enctype="multipart/form-data">
                @csrf
            @else
                <form class="form-horizontal" action="{{ route('bbb.virtual-class.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                ...
                <div class="white-box">
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input">
                                ...
                                <input
                                    ...
                                    value="123456"
                                    value="{{ isset($editdata) ? old('attendee_password', $editdata->attendee_password) : 123456 }}">
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input">
                                <input
                                    ...
                                    type="hidden" name="moderator_password" autocomplete="off" value="001122">
                            ...
                            <div class="primary_input">
                                <div class="primary_file_uploader">
                                    ...
                                    <input
                                        ...
                                        placeholder="{{ isset($editdata->logo) && @$editdata->logo != '' ? getFilePath3(@$editdata->logo) : trans('common.attached_file') }}"
                                        id="placeholderInput">
                                    <button class="" type="button">
                    ...
                    <div class="row mt-15" style="display:none;">
                        <div class="col-lg-12 d-flex">
                            <p class="fw-500 mb-10" style="width: 130px;">@lang('bbb::bbb.change_default_settings')</p>
                    ...
                    <div class="row mb-40  default-settings">
                                ...
                                <div class="col-lg-12">
                                    <div class="radio-btn-flex ml-20">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="">
                                                    <input oninput="numberMinZeroCheck(this)" type="text"
                        ...
                        <!-- <div class="col-lg-12 mt-10">
                                        <div class="row">
                                            {{--   <div class="col-lg-12 d-flex">
                                                   <p class="fw-500 mb-10">{{__('Logo')}} </p>
                                               </div> --}}
                                            <div class="col-lg-12">
                                                <div class="radio-btn-flex ml-20">
                                                    <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="">
                                                            ...
                                                            <label for="lock_settings_disable_mic">
                                                                @lang('common.disable')
                                                            </label>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-lg-12 text-center">
                            @if (empty($env['security_salt']) || empty($env['server_base_url']))
                                <small class="text-danger">*
                                    @lang('bbb::bbb.please_make_sure_bbb_api_key_setup_successfully_without_bbb_api_setup_you_can_not_create_class')
                                </small>
                            @else
