...
class CreateSmSaasPaymentGatewaySettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
            ...
            Schema::create('sm_saas_payment_gateway_settings', function (Blueprint $table) {
                $table->increments('id');
            ...
            DB::table('sm_saas_payment_gateway_settings')->insert([
                [
                    'gateway_name'          => 'Stripe',
    ...
    {
        Schema::dropIfExists('sm_saas_payment_gateway_settings');
    }
}
