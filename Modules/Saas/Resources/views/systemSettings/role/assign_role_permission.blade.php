    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('role')}}">@lang('system_settings.role')</a>
                                                    ...
                                                    <div class="card-body">
                                                        @foreach($module_linksL as $module_link)
                                                                ...
                                                                @if (strpos($module_link->name, '➡') !== false)
                                                                    @php $cssss="background:white;"; $cssss2="padding-left:40px !important;"; @endphp
                                                                @else
                                                                    @php $cssss="background:#f4f4f4;";  $cssss2="padding-left:0px !important;";  @endphp
                                                                @endif

                                                        <div class="row py-3 border-bottom align-items-center" style="{{isset($cssss)?$cssss:''}}">
                                                            <div class="offset-lg-3 col-lg-5" style="{{isset($cssss2)?$cssss2:''}}">{{$module_link->id }} {{$module_link->name }}</div>
                                                            <div class="col-lg-4">
                                                                <div class="">
