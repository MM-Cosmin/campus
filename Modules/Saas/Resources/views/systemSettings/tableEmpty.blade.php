                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    <div class="row">
                                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'administrator/database-delete','method' => 'POST']) }}
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 text-right">
                                            <a href="{{route('database-restore')}}" class="primary-btn fix-gr-bg"> <span
                                                        class="ti-check"></span> Sample Data Restore </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
