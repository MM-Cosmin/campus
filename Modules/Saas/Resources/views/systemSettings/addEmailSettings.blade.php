        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"> @lang('common.add_email_settings')</h3>
                </div>
            </div>
        </div>
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'method' => 'POST', 'route' => 'administrator/add-email-settings-data', 'id' => 'email_settings1', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="row justify-content-center mb-30">
                        <div class="col-lg-6">
                            <div class="primary_input">
                                ...
                                type="text" name="from_name" id="from_name" autocomplete="off" value="">
                        ...
                        <div class="col-lg-6">
                            <div class="primary_input">
                                ...
                                type="text" name="from_email" id="from_email" autocomplete="off" value="">
                    ...
                    <div class="row justify-content-center mb-30">
                        <div class="col-lg-6">
                            <div class="primary_input">
                                ...
                                type="text" name="mail_host" id="mail_host" autocomplete="off" value="">
                        ...
                        <div class="col-lg-6">
                            <div class="primary_input">
                                ...
                                type="text" name="mail_port" id="mail_port" autocomplete="off" value="">
                    ...
                    <div class="row justify-content-center mb-30">
                        <div class="col-lg-6">
                            <div class="primary_input">
                                ...
                                type="text" name="mail_username" id="mail_username" autocomplete="off" value="">
                        ...
                        <div class="col-lg-6">
                            <div class="primary_input">
                                ...
                                type="password" name="mail_password" id="mail_password" autocomplete="off" value="">
                    ...
                    <div class="row mb-30">
                        <div class="col-lg-6">
                            <div class="primary_input">
                                ...
                                type="text" name="mail_encryption" id="mail_encryption" autocomplete="off" value="">
                        ...
                        <div class="col-lg-6">
                            <div class="primary_input">
                                ...
                                type="text" name="mail_driver" id="mail_driver" autocomplete="off" value="">
