            ...
            <div class="col-lg-9">
                <div class="row xm_3">
                    ...
                    @if (!empty($editData))
                        ...
                        <a href="{{route('administrator/update-general-settings')}}" class="primary-btn small fix-gr-bg"> <span class="ti-pencil-alt"></span> @lang('common.edit')
                        </a>
                    </div>
                    @else
                        <div class="offset-lg-6 col-lg-2 text-right col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="value text-left">
                                                ...
                                                @if(isset($editData))
                                                    {{$editData->session_id ? $editData->academic_Year->year:""}}
