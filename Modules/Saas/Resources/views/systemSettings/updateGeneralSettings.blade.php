...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        ...
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'administrator/update-general-settings-data', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-3">
                                    <div class="primary_input">
                                        <label>@lang('common.select_time_zone') <span>*</span></label>
                                         ...
                                         <select name="currency" class="primary_select form-control {{ $errors->has('currency') ? ' is-invalid' : '' }}" id="currency">
                                            <option data-display="@lang('system_settings.select_currency')" value="">@lang('system_settings.select_currency')</option>
                                             @foreach($currencies as generalSetting()->currency_symbol)
                                                <option value="{{generalSetting()->currency_symbol->code}}" {{isset($editData)? ($editData->currency  == generalSetting()->currency_symbol->code? 'selected':''):''}}>{{generalSetting()->currency_symbol->name}} ({{generalSetting()->currency_symbol->code}})</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('currency'))
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row md-30">
                            <div class="col-lg-12">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('system_settings.school_address') <span></span> </label>
                                    <textarea class="primary_input_field form-control" cols="0" rows="4" name="school_address" id="school_address">{{isset($editData) ? @$editData->school_address : old('school_address')}}</textarea>
                                </div>
                            </div>
                        </div>
