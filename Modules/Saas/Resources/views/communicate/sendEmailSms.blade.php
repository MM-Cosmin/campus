...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('communicate.payment_id') </h1>
            <div class="bc-pages">
...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
        ...
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'administrator/send-email-sms', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="white-box">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-30">
                                            <input class="primary_input_field{{ $errors->has('email_sms_title') ? ' is-invalid' : '' }}" type="text" name="email_sms_title" autocomplete="off" value="{{ old('email_sms_title') }}">
                            ...
                            <strong>{{ $errors->first('email_sms_title') }}</strong>
                                        ...
                                        <div class="primary_input">
                                            <textarea class="primary_input_field {{ $errors->has('description') ? ' is-invalid' : '' }}" cols="0" rows="4" name="description" id="details">{{ old('description') }}</textarea>
                        ...
                        <div class="row student-details">
                            ...
                            <div class="col-lg-12">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#group_email_sms" selectTab="G" role="tab" data-toggle="tab">@lang('common.group')</a>
                                    </li>
                                    <li class="nav-item">
                                            ...
                                            <div class="row mb-35">
                                                ...
                                                <div class="col-lg-12">
                                                    <select class="primary_select form-control{{ $errors->has('role_id') ? ' is-invalid' : '' }}" name="role_id" id="staffsByRoleCommunication">
                                                        <option data-display="@lang('common.role')  *" value="">@lang('common.role') *</option>
