    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#">@lang('exam.add_exam_type')</a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            <input class="primary_input_field{{ $errors->has('exam_type_title') ? ' is-invalid' : '' }}" type="text" name="exam_type_title" autocomplete="off" value="{{isset($exam_type_edit)? $exam_type_edit->title : ''}}">
                                            <input type="hidden" name="id" value="{{isset($exam_type_edit)? $exam_type_edit->id: ''}}">
                                            <label> @lang('onlineexam::onlineExam.exam_name') <span>*</span></label>
                                    ...
                                    @if(isset($exam_type_edit))
                                        <div class="col-lg-12 mt-30-md">
                                            <select class="primary_select form-control {{ $errors->has('active_status') ? ' is-invalid' : '' }}" id="active_status" name="active_status">
                                                <option data-display=" @lang('exam.select_status') *" value="">@lang('exam.select_status') *</option>
                            ...
                            <thead>
                               @if(session()->has('message-success-delete') != "" ||
                                ...
                                <tr>
                                    ...
                                    <th>@lang('onlineexam::onlineExam.exam_name')</th>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('common.delete_exam_type')</h4>
