                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <select class="primary_select form-control {{ $errors->has('receiver') ? ' is-invalid' : '' }}" name="receiver">
                                    ...
                                    <option value="students"  {{( old('receiver') == 'students' ? "selected":"")}}>@lang('exam.students')</option>
                                    <option value="parents"  {{( old('receiver') == 'parents' ? "selected":"")}}>@lang('exam.parents')</option>
