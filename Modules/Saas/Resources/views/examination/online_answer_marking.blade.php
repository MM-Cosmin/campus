    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('online-exam')}}">Online Exam</a>
            </div>
        </div>
    </div>
</section>
                            ...
                            <tbody>
                                <tr align="center">
                                    <td colspan="3">
                                        ...
                                        <h3><strong>Subject: </strong>{{$take_online_exam->onlineExam!=""?$take_online_exam->onlineExam->subject->subject_name:""}}</h3>
                                        <h3><strong>Total Marks: </strong></h3>
                                        <h3><strong>Exam Has To Be Submitted Within: </strong>{{$take_online_exam->onlineExam !=""?$take_online_exam->onlineExam->date:""}} {{$take_online_exam->onlineExam!=""?$take_online_exam->onlineExam->end_time:""}}</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Question</th>
                                ...
                                <tr>
                                    <td width="60%">
                                        ...
                                        @else
                                            ...
                                            <div class="primary_input mt-20">
                                                <textarea class="primary_input_field mt-10" cols="0" rows="5" name="suitable_words_{{$question->question_bank_id}}">{{$question->suitable_words}}</textarea>
                                    ...
                                    <td width="20%" class="text-right"><strong>{{$question->questionBank !=""?$question->questionBank->marks:""}}</strong></td>
