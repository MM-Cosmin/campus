                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <textarea class="primary_input_field{{ $errors->has('description') ? ' is-invalid' : '' }}" cols="0" rows="4" name="description">{{isset($instruction)? $instruction->description: ''}}</textarea>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{route('instruction-edit', [$instruction->id])}}">edit</a>
