            ...
            <div class="col-lg-12">
                ...
                <div class="row no-gutters input-right-icon mt-35">
                    <div class="col">
                        <div class="primary_input">
                            <input class="primary_input_field date" id="startDate" type="text" name="date" onkeyup="examRoutineCheck()" value="{{isset($assigned_exam)? date('m/d/Y', strtotime($assigned_exam->date)):''}}" readonly="true">
                                <label>Date</label>
                ...
                <div class="row mt-25">
                    <div class="col-lg-12 mt-30-md">
                        <select class="primary_select form-control" name="room" id="room">
