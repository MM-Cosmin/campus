    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('exam_attendance_create')}}">@lang('exam.attendance_create')</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <button type="submit" class="primary-btn fix-gr-bg mb-20 submit" onclick="javascript: form.action='{{route('exam-attendance-store')}}'">
                        ...
                        <table id="table_id_table" class="display school-table" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th width="25%">@lang('student.student_number')</th>
                                        ...
                                        <td>
                                            <div class="d-flex radio-btn-flex">
                                                <div class="mr-20">
                                                    ...
                                                    <label for="attendanceP{{$student->id}}">@lang('exam.present')</label>
                                                </div>
                                                <div class="mr-20">
                                                    <input type="radio" name="attendance[{{$student->id}}]" id="attendanceL{{$student->id}}" value="A" class="common-radio">
                                                    <label for="attendanceL{{$student->id}}">@lang('exam.absent')</label>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
