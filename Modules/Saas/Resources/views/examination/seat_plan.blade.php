                                ...
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field date" id="startDate" type="text" name="date" autocomplete="off">
                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">@lang('common.student')</th>
                            <th width="10%">@lang('common.class_Sec')</th>
                            <th width="10%">@lang('exam.total_students')</th>
