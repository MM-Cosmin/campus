        ...
        <div class="add-visitor">
            <div class="common-fields" id="common-fields">
                ...
                <div class="row mt-25">
                    <div class="col-lg-12">
                        <div class="primary_input">
                            <textarea class="primary_input_field" cols="0" rows="5" name="question_title" required>{{$online_exam_question->title}}</textarea>
            ...
            <div class="multiple-choice" id="multiple-choice">
                ...
                <div class="row  mt-25">
                    ...
                    <div class="col-lg-2">
                        <button type="button" id="create-option-edit">Create</button>
                    </div>
                </div>
            ...
            <div class="fill-in-the-blanks" id="fill-in-the-blanks">
                <div class="row  mt-25">
                    <div class="col-lg-12">
                        <div class="primary_input">
                            <textarea class="primary_input_field" cols="0" rows="5" name="suitable_words" required>{{$online_exam_question->suitable_words}}</textarea>
