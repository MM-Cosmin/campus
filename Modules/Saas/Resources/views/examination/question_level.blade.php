    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('question-level')}}">Question Level</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($level))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => array('question-level-update',$level->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                        @else
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            <input class="primary_input_field{{ $errors->has('level') ? ' is-invalid' : '' }}"
