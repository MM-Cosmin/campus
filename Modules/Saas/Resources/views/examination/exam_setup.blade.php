                            ...
                            <div class="add-visitor">
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            <input oninput="numberCheckWithDot(this)" class="primary_input_field{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            <input oninput="numberCheckWithDot(this)" class="primary_input_field{{ $errors->has('exam_mark') ? ' is-invalid' : '' }}"
               ...
               <div class="white-box">
                  ...
                  <tbody>
                      <tr id="row1" class="0">
                            ...
                            <td class="border-top-0">
                                <div class="primary_input">
                                    <input class="primary_input_field{{ $errors->has('exam_mark') ? ' is-invalid' : '' }} exam_mark"
