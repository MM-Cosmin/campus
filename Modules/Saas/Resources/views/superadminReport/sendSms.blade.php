    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('communicate.send_sms')</h1>
                <div class="bc-pages">
                    <a href="{{ route('dashboard') }}">@lang('common.dashboard')</a>
                    <a href="#">@lang('communicate.communicate')</a>
                    <a href="#"> @lang('communicate.send_sms')</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="main-title">
                        <h3 class="mb-30">@lang('communicate.send_sms') </h3>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-30">
                                                ...
                                                <input
                                                    class="primary_input_field{{ $errors->has('email_subject') ? ' is-invalid' : '' }}"
                                            ...
                                            <div class="primary_input">
                                                ...
                                                <textarea class="primary_input_field " cols="0"
