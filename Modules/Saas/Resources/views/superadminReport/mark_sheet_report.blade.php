    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-8 pull-right">
                <a href="{{route('saas_mark_sheet_report', [$input['exam_id'], $input['class_id'], $input['section_id'], $input['student_id'], $input['school_id']])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> Print</a>
            </div> 
        </div>
        <div class="row">
            <div class="col-lg-12">
                                        ...
                                        <table class="w-100 mt-30 mb-20 table   table-bordered marksheet">
                                            ...
                                            @foreach($subjects as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                             {{$tola_mark_by_subject=App\SmAssignSubject::getSumMarkSuperadmin($student_detail->id, $data->subject_id, $class_id, $section_id, $exam_type_id)}}
                                                    </td>
                                                    <td>
                                                    ...
                                                    @if($subject_count==2)
                                                        <td rowspan="{{count($subjects)}}" style="vertical-align: middle">{{  App\SmAssignSubject::get_student_resultSuperadmin($student_detail->id, $class_id, $section_id, $exam_type_id) }}</td>
                                                    @endif
