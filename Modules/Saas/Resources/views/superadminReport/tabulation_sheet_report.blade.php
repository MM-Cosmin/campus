    ...
    <section class="admin-visitor-area">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @endif
                <div class="white-box">
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'administrator/tabulation-sheet-report', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                    <div class="row">
                        <input type="hidden" name="url" id="url" value="{{URL::to('/')}}">

                        <div class="col-lg-4 mt-30-md">
                                <select class="primary_select form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}" name="institution" id="select-institution-result">
                            ...
                            <div class="col-lg-4 mt-30-md" id="select_exam_div">
                                <select class="primary_select form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}" name="exam" id="select_exam">
            ...
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-30 mt-30"> @lang('reports.tabulation_sheet_report')</h3>
                        </div>
                    </div>
                    <div class="col-lg-8 pull-right mt-20">

                        <div class="print_button pull-right">
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'administrator/tabulation-sheet/print', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student', 'target' => '_blank']) }}
                        ...
                        <div class="white-box">
                                    ...
                                    <div class="row">
                                            ...
                                            @if(@$tabulation_details['student_name'])
                                                @if(@$tabulation_details['student_name'])
                                                    <p class="student_name">
                                                        <strong>@lang('student.student_name') </strong> {{$tabulation_details['student_name']}}
                                                    </p>
                                                @endif
                                                @if(@$tabulation_details['student_roll'])
                                                    <p class="student_name">
                                                        <strong>@lang('student.student_roll') </strong> {{$tabulation_details['student_roll']}}
                                                    </p>
                                                @endif
                                                @if(@$tabulation_details['student_admission_no'])
                                                    <p class="student_name">
                                                        <strong>@lang('student.student_admission') </strong> {{$tabulation_details['student_admission_no']}}
                                                    </p>
                                                @endif
                                            @else
                                        ...
                                        <div class=" col-lg-6">
                                            ...
                                            @if(@$tabulation_details['student_class'])
                                                <p class="student_name">
                                                    <strong>@lang('common.class')  </strong> {{$tabulation_details['student_class']}}
                                                </p>
                                            @endif
                                            @if(@$tabulation_details['student_section'])
                                                <p class="student_name">
                                                    <strong>@lang('common.section') </strong> {{$tabulation_details['student_section']}}
                                                </p>
                                            @endif
                                            @if(@$tabulation_details['student_admission_no'])
                                                <p class="student_name">
                                                    <strong> @lang('exam.exam') </strong> {{$tabulation_details['exam_term']}}
                                                </p>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="mt-30 mb-20 table table-striped table-bordered ">
                                    <thead>
                                    <tr>
                                        <th rowspan="2">@lang('common.sl')</th>
                                        <th rowspan="2">@lang('student.student_name')</th>
                                        ...
                                        <th rowspan="2">@lang('exam.gpa_grade')</th>
                                    </tr>
                                    <tr>
                                    ...
                                    @foreach($students as $student)
                                        ...
                                        <tr>
                                            ...
                                            @foreach($subjects as $subject)
                                                ...
                                                <td class="total">
                                                    @php
                                                        $tola_mark_by_subject = App\SmAssignSubject::getSumMarkSuperadmin($student->id, $subject_ID, $class_id, $section_id, $exam_term_id);
