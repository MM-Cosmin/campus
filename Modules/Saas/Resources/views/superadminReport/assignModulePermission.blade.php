    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#">@lang('system_settings.assign_permission')</a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="row">
                        <div class="col-lg-6 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30">@lang('system_settings.assign_permission') ({{' for '. $institution->school_name}})</h3>
                            </div>
                        </div>
                    </div>
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'administrator/module-permission-store', 'method' => 'POST']) }}
                    <input type="hidden" name="school_id" value="{{$institution->id}}">
                    <div class="row">
