    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    @endif
                <div class="white-box">
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'administrator/staff-attendance', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                        <div class="row">
                            ...
                            <div class="col-lg-3 mt-30-md">
                                <select class="primary_select form-control {{ $errors->has('role') ? ' is-invalid' : '' }}" id="select_class" name="role">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="lateday d-flex mt-4 justify-content-center">
                        <div class="mr-3">@lang('hr.present'): <span class="text-success text-bold">P</span></div>
                        <div class="mr-3">@lang('hr.late'): <span class="text-warning text-bold">L</span></div>
                        <div class="mr-3">@lang('hr.absent'): <span class="text-danger text-bold">A</span></div>
                        <div class="mr-3">@lang('hr.holiday'): <span class="text-dark text-bold">H</span></div>
                        <div>@lang('hr.half_day'): <span class="text-info text-bold">F</span></div>
                    </div>
