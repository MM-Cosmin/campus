                            ...
                            <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                <input class="primary_input_field date form-control{{ $errors->has('date_from') ? ' is-invalid' : '' }}" id="startDate" type="text"
                                                    ...
                                                    <label>@lang('reports.date_from')</label>
                                ...
                                <div class="col-lg-6 mt-30-md">
                                    <div class="no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="primary_input">
                                                <input class="primary_input_field date form-control{{ $errors->has('date_to') ? ' is-invalid' : '' }}" id="startDate" type="text"
                                                     name="date_to" value="{{date('m/d/Y')}}" readonly>
                                                    <label>@lang('reports.date_to')</label>
                                                    <span class="focus-border"></span>
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        ...
                                        @php $total = 0; @endphp
                                        <tr>
                                            <td  data-sort="{{strtotime($fees_payment->payment_date)}}" >{{ !empty($fees_payment->payment_date)? dateConvert($fees_payment->payment_date):''}} </td>
                                ...
                                <tfoot>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th>@lang('reports.grand_total') </th>
                                    <th>{{$grand_fine}}</th>
                                </tfoot>
                            </table>
                        </div>
