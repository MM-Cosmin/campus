        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <p class="mb-0"> @lang('common.academic_year') : <span class="primary-color fw-500">{{generalSetting()->session_year}}</span> </p>
                    <p class="mb-0"> @lang('exam.exam') : <span class="primary-color fw-500">{{$exam_name}}</span> </p>
                    <p class="mb-0"> @lang('common.class') : <span class="primary-color fw-500">{{$class_name}}</span> </p>
                    <p class="mb-0"> @lang('common.section') : <span class="primary-color fw-500">{{$section->section_name}}</span> </p>
                </td>
                <td> 
                    <p style="font-weight: 500; border-bottom:1px solid #ddd">@lang('exam.subjects_list')</p> 
                    <div class="row">
                                        ...
                                        <table class="marklist" style="width: 100%">
                                            <thead>
                                                <tr style="border-bottom: 1px solid black !important">
                                                    <th>Merit @lang('exam.position')</th>
