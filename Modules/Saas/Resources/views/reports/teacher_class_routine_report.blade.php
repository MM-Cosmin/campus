...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('reports.teacher_class_routine_report')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('common.dashboard')</a>
                <a href="#">@lang('reports.reports')</a>
                <a href="#">@lang('reports.teacher_class_routine_report')</a>
            </div>
        </div>
    </div>
</section>
                        ...
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'teacher-class-routine-report', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-30-md">
                                    <select class="primary_select form-control {{ $errors->has('teacher') ? ' is-invalid' : '' }}" name="teacher">
