...
$package_info = Modules\Saas\Entities\SmPackagePlan::find($package);

$package_setting = Modules\Saas\Entities\SmSaasSubscriptionSetting::find(1);
$tax = $package_info->price / 100 * $package_setting->amount;
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td colspan="3">
												...
												You have successfully purchased a subscription package. The package information is below.<br><br>
											</td>
										</tr>
							                ...
							                <tr>
							                    <th>{{$package_info->name}} </th>
							                    <th>{{$package_info->duration_days}} days</th>
							                    <th>{{number_format($package_info->price, 2)}}</th>
							                </tr>
							                <tr>
							                	<th colspan="3"><hr></th>
							                </tr>
							                ...
							                <tr>
							                    ...
							                    <th>
							                        {{number_format($package_info->price + $tax, 2)}}
							                    </th>
							                </tr>

							                <tr>
											<td colspan="3"  style="padding-top:25px;">
												<strong>Thanking</strong><br><br>
