...
@section('title')
@lang('saas::saas.payment_method_settings')
@endsection
@section('mainContent')
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('saas::saas.payment_method_settings')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('common.dashboard')</a>
                <a href="#">@lang('saas::saas.subscription')</a>
                <a href="#">@lang('saas::saas.payment_method_settings')</a>
            </div>
        </div>
    </div>
</section>
<section class="mb-40 student-details">
    <div class="container-fluid p-0">
        <div class="row">
                ...
                <!-- Select a Payment Gateway -->    
                 <div class="col-lg-3">
                    <div class="main-title">
                        <h3 class="mb-15">@lang('saas::saas.select_a_payment_gateway')   </h3>
                    </div>
                    
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'subscription/is-active-payment']) }}
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                 ...
                                 @foreach($paymeny_gateway as $value)
                                  @if(moduleStatusCheck('RazorPay') == FALSE && $value->method =="Razorpay" )  @php continue; @endphp @endif
            ...
            <div class="col-lg-9">
                 <ul class="nav nav-tabs justify-content-end mt-sm-md-20 mt-1" role="tablist">
                    @foreach($paymeny_gateway_settings as $row) 
                        <li class="nav-item">
                            <a class="nav-link @if($loop->index == 0) active show @endif " href="#{{@$row->gateway_name}}" role="tab" data-toggle="tab">{{@$row->gateway_name}}</a>
                        </li> 
                    @endforeach 
                </ul>
                ...
                <div class="tab-content">
                    ...
                    @foreach($paymeny_gateway_settings as $row) 
                            ...
                            <div role="tabpanel" class="tab-pane fade   @if($loop->index == 0) active show @endif " id="{{@$row->gateway_name}}">
 
                                
                                    <form class="form-horizontal" action="{{route('subscription/update-payment-gateway')}}" method="POST">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="row mb-15">
                                               <div class="col-md-10">
                                                ...
                                                if(@$row->gateway_name=="Stripe" || @$row->gateway_name=="Paystack" || @$row->gateway_name=="RazorPay" || @$row->gateway_name=="PayPal"){
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 mb-15">
                                                                <div class="primary_input">
                                                                    ...
                                                                    <input class="primary_input_field{{ $errors->has($input_field) ? ' is-invalid' : '' }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 mt-15">
                                                                <div class="primary_input sm2_mb_20">
                                                                    ...
                                                                    <textarea class="primary_input_field article-ckeditor form-control" cols="0" rows="3" name="{{$input_field}}" id="article-ckeditor">{{@$value}}</textarea>
