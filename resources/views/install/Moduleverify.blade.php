                ...
                <div class="justify-content-center">
                    ...
                    <form method="POST" action="{{url('module-verify-purchase')}}" class="mt-40">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " name="envatouser"  required="required"  placeholder="Enter Your Envato User Name" value="Nulled by codingshop.net">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="purchasecode" required="required" placeholder="Enter Your Envato Purchase Code" value="Nulled by codingshop.net">
                        </div>
                        <div class="form-group">
