                            ...
                            <div class="add-visitor">
								...
								<div class="row mt-15">
                                    <div class="col-lg-12">
                                     ...
                                     <label class="primary_input_label" for="">
                                          @lang('academics.teacher') 
                                          <span class="text-danger"> *</span>
                                      </label>
                                      <select class="primary_select form-control {{ @$errors->has('class') ? ' is-invalid' : '' }}" id="" name="teacher">
                                          <option data-display="@lang('academics.teacher') *" value="">@lang('academics.teacher') *</option>
                                          @foreach($teachers as $teacher)
                                          @if(isset($assign_class_teacher))
                                          <option value="{{ @$teacher->id }}" {{ $assign_class_teacher ? 'selected' : '' }}>{{ @$teacher->full_name }}</option>
                                          @else
