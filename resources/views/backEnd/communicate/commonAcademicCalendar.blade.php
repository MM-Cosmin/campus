                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">PROFESOR
                                                <span class="text-danger"></span> </label>
                                            <input
                                                class="primary_input_field form-control commonInputBlank"
                                                type="text" name="event_profesor" autocomplete="off"
                                                value="">
                                            <span id="error_event_profeso" class="text-danger commonErrorBlank"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">ASIGNATURA
                                                <span class="text-danger"></span> </label>
                                            <input
                                                class="primary_input_field form-control commonInputBlank"
                                                type="text" name="event_asignatura" autocomplete="off"
                                                value="">
                                            <span id="error_event_asignatura" class="text-danger commonErrorBlank"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">TEMA
                                                <span class="text-danger"></span> </label>
                                            <input
                                                class="primary_input_field form-control commonInputBlank"
                                                type="text" name="event_tema" autocomplete="off"
                                                value="">
                                            <span id="error_event_tema" class="text-danger commonErrorBlank"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="primary_input_label" for="from_date">Hora de inicio <span
                                                    class="text-danger"></span></label>
                                        <div class="primary_input">
                                            <input
                                    ...
                                    <div class="col-lg-3">
                                        <label class="primary_input_label" for="from_date">Hora de fin <span
                                                    class="text-danger"></span></label>
                                        <div class="primary_input">
                                            <input
