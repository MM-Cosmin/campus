...
class SmEventController extends Controller
{
    ...
    public function store(EventRequest $request)
    {
        try {
            ...
            //$events->start_time = date('h:i A', strtotime($request->start_time));
            //$events->end_time = date('h:i A', strtotime($request->end_time));
            //$events->event_profesor = $request->event_profesor;
            //$events->event_asignatura = $request->event_asignatura;
            $events->event_tema = $request->event_tema;
