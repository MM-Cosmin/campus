...
class LoginController extends Controller
{
    ...
    public function loginFormTwo()
    {
        ...
        if (empty($login_background)) {
            $data['css'] = "background: url(" . url('public/backEnd/login2/img/login-bg.svg') . ")  no-repeat center; background-size: cover; ";
        } else {
    ...
    public function loginCodeCanyon()
    {
        ...
        if (empty($login_background)) {
            $css = "background: url(" . url('public/backEnd/img/login-bg.svg') . ")  no-repeat center; background-size: cover; ";
        } else {
            if (!empty($login_background->image)) {
